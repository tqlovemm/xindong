...
class UploadThumb
{
     ...
     */
    public function __construct( $fileField , $config , $prefix = '', $thumb = false,$base64 = false)
    {
    ...
    private function upFile( $base64 )
    {
        ...
        if($this->thumb){
            $this->waterMark =  $folder . '/thumb/' . $this->fileName;
            $this->thumb($this->fullName);
            //Thumb::mkThumbnail($this->fullName,420,420,$this->waterMark);
        }
