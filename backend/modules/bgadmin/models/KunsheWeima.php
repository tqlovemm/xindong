 ...
 */
class KunsheWeima extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasOne(KunsheWeimaFollowCount::className(), ['sence_id' => 'sence_id'])->where(['created_at'=>strtotime('today')]);
    }
    public function getNum()
    {
        return $this->hasMany(KunsheWeimaRecord::className(), ['scene_id' => 'sence_id'])->where(['status'=>1]);
    }
}
