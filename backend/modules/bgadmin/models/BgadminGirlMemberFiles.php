...
/**
 * This is the model class for table "pre_bgadmin_girl_member_files".
 *
 * @property integer $id
 ...
 */
class BgadminGirlMemberFiles extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pre_bgadmin_girl_member_files';
    }
    ...
    {
        return $this->hasOne(BgadminGirlMemberText::className(), ['text_id' => 'text_id']);
    }
}
