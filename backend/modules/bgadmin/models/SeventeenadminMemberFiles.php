...
/**
 * This is the model class for table "pre_17admin_member_files".
 *
 * @property integer $id
 ...
 */
class SeventeenadminMemberFiles extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pre_17admin_member_files';
    }
    ...
    {
        return $this->hasOne(SeventeenadminMemberText::className(), ['text_id' => 'text_id']);
    }
}
