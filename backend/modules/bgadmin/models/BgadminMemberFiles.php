...
/**
 * This is the model class for table "pre_bgadmin_member_files".
 *
 * @property integer $id
 ...
 */
class BgadminMemberFiles extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pre_bgadmin_member_files';
    }
    ...
    {
        return $this->hasOne(BgadminMemberText::className(), ['text_id' => 'text_id']);
    }
}
