...
?>
    ...
    <div id="member__search" class="form-group clearfix">
        <form action="to-check" method="get">
            ...
            <div class="row" style="background-color: <?=$color?>;border-bottom:1px solid red;margin-top: 10px;padding:5px;margin-left: 0;margin-right: 0;">
                            ...
                            if(!empty($member)){
                                ...
                                if(!empty($file)){
                                    ...
                                    if(!empty($file['memberFiles'])){
                                        echo "二维码：<a href=http://13loveme.com:82/{$file['memberFiles'][0]['path']}  data-lightbox='s' data-title='s'><img class='img-responsive img-thumbnail' style='width: 100px;height: 100px;' src=http://13loveme.com:82/{$file['memberFiles'][0]['path']}></a>";
                ...
                <div class="col-md-2" style="padding:0">
                    ...
                    <?php if($model['platform']==2){
                        echo "<h4 style='color:red;'>此会员通过app端报名，无需点击-微信推送联系方式</h4>";
                    }?>
                </div>
