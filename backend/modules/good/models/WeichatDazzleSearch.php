...
/**
 * WeichatDazzleSearch represents the model behind the search form about `backend\modules\good\models\WeichatDazzle`.
 */
class WeichatDazzleSearch extends WeichatDazzle
{
    /**
     * @inheritdoc
     */
