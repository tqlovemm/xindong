...
<div class="box box-success" style="background-color: #fff;width: 50%;text-align: center;">
...
<div class="clearfix" style="background-color: #fff;width: 50%;margin: 10px 0;padding: 10px;">
    <form class="col-md-6">
...
<div class="box box-danger contents" style="background-color: #fff;width: 50%;text-align: center;"></div>
<?php
$this->registerJs("
