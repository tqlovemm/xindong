...
use backend\modules\weekly\models\WeeklyContentSearch;
 ...
 */
class WeeklyContentSearchController extends Controller
{
    ...
    {
        $searchModel = new WeeklyContentSearch();
     ...
     * @param string $id
     * @return WeeklyContent the loaded model
