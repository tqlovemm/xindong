...
<div class="album-view">
    ...
    <?= Html::a('<i class="glyphicon glyphicon-edit"></i> ' . Yii::t('app', 'Edit Seeks'), ['/weekly/weekly/update', 'id' => $model->id], ['class' => 'btn btn-default']) ?>
    <?php if ($model->photoCount == 0 && $model->created_by === Yii::$app->user->id): ?>
        <div class="no-photo">
            ...
            <div class="no-photo-msg">                       
                ...
                <div class="button">
                    <div class="bigbutton">
                        <a href="<?= Url::toRoute(['/weekly/weekly/upload', 'id' => $model->id]) ?>" class="btn btn-default">
        ...
        <div class="img-all row clearfix">
            ...
            <?php foreach ($model->photos['photos'] as $photo): ?>
                <div class="img-item col-md-2" id="<?= $photo['id'] ?>">
                    <div class="img-wrap">
                        <div class="img-edit">
                            <a href="<?= Url::toRoute(['/weekly/weekly-content/delete', 'id' => $photo['id']]) ?>" data-clicklog="delete" data-confirm="Are you sure to delete it?" data-method="post" onclick="return false;" title="<?= Yii::t('app', 'Are you sure to delete it?') ?>">
                                <span class="img-tip"><i class="glyphicon glyphicon-remove"></i></span>
                            </a>
                        </div>
                        <div class="img-main">
                            <a title="<?= Html::encode($photo['name']) ?>" href="<?=Url::to(['/weekly/weekly-content-search/view','id'=>$photo['id']])?>">
