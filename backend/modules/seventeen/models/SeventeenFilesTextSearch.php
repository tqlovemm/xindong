...
/**
 * SeventeenFilesTextSearch represents the model behind the search form about `backend\modules\seventeen\models\SeventeenFilesText`.
 */
class SeventeenFilesTextSearch extends SeventeenFilesText
{
    /**
     * @inheritdoc
     */
