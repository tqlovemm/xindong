...
final class PersistentFop
{
    ...
    public function execute($key, $fops)
    {
        ...
        \common\Qiniu\setWithoutEmpty($params, 'pipeline', $this->pipeline);
        \common\Qiniu\setWithoutEmpty($params, 'notifyURL', $this->notify_url);
        if ($this->force) {
            $params['force'] = 1;
        }
