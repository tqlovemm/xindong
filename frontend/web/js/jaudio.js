...
(function($){
  ...
  Plugin.prototype = {
    ...
    {
      var self        = this,
          playButton  = self.$domControls.find("#button-play");
      ...
      playButton.attr("id", "button-pause");
    ...
    {
      var self        = this,
          playButton  = self.$domControls.find("#button-pause");
      ...
      playButton.attr("id", "button-play");
