            ...
            <div class="bd" style="padding-top: 15px;">
                <ul>
                    <?php foreach ($imgs as $img):?>
                        <li>
                            <img class="img-responsive center-block" src="http://13loveme.com/<?=$img->img?>">
                        </li>
                    <?php endforeach;?>
                </ul>
            </div>
...
<div class="bd">
    ...
    <div class="weui_cells">
        <div class="row" style="margin: 0;background-color: #fff;padding:10px 0;">
            <div class="col-xs-5" style="background-image: url('/images/collecting-files/517865065565295460.png');background-size:cover;color: #EFB810;background-repeat: no-repeat;padding:8px 20px;text-align: center;border-bottom-right-radius: 5px;border-top-right-radius: 5px;">
                编号：<?=$model->id?>
            </div>
