...
<div class="row list-header">
    ...
    <a href="seventeen-code?flag=<?=$flags?>" style="left:15px;"><span class="glyphicon glyphicon-home"></span></a>
...
<script>
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({
            ...
            link: 'http://13loveme.com/wei-xin/share-list?flag=<?=$flag?>', // 分享链接
            imgUrl: 'http://13loveme.com<?=$img?>', // 分享图标
