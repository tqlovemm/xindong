...
$this->registerCss('
        ...
        .like-list i{color:white;font-weight:bold;font-size:18px;margin-left:5px;}
        .like-list a{color:white;font-weight:bold;font-size:16px;}
...
<div class="container container-box" style="position: relative;">
        ...
        <article class="flop">
                ...
                <ul id="myTabFlop" class="flop-choices nav nav-tabs" style="position: relative;height:10%;">
                        ...
                        <li id="more-area" style="position: absolute;left:50%;margin-left: -47px;"><a href="<?=\yii\helpers\Url::to(['area-choice','openid'=>$openid])?>" style="font-size: 16px;padding:15px;">其他地区</a></li>
                <!--        <li class="pull-right"><a id="good-choice" href="#ios" data-toggle="tab">精选</a></li>-->
                        <li class="dropdown pull-right">
                                <a href="#" id="flop-choice-drop" class="dropdown-toggle" data-toggle="dropdown"><content id="flop-choice-drop-1">更多</content><b class="caret"></b></a>
                ...
                <script>
                        function SetCookie(name, value) {
                                var Days = 30;
                                var exp = new Date();
                                exp.setTime(exp.getTime() + 10*1000);//过期时间 一天
                        ...
                        $(function(){
                                ...
                                $('#flop-choice-lists li a').on('click',function(){
                                        ...
                                        if(document.cookie.indexOf("https://www.13loveme.com=")==-1){
                                ...
                                $('.my-modal2 a').click(function(){
                                        ...
                                        if($('.my-modal2 input').val()==13){
                                                $('.my-modal2').fadeOut();
                                                SetCookie('https://www.13loveme.com','shisanpingtai');
                                        }else {
                ...
                <div id="myTabContent" class="tab-content" style="width: 100%;height: 90%;">
                        ...
                        <div class="flop-content tab-pane fade in active" id="home" style="height: 100%;">
                                ...
                                <div class="like-list text-center text-bold">
                                        <a class="btn btn-danger" style="width: 100%;" href="<?=$web_url?>wei-flops?flag=<?=$cookies->getValue('flag2')?>&openid=<?=$openid?>">我的后宫<i class="like-count"> +<?=$count?></i></a>
        ...
        <div id="my-modal-full" class="my-modal text-center">
                ...
                <a href="<?=$web_url?>flop-list?flag=<?=$cookies->getValue('flag2')?>&openid=<?=$openid?>" class="btn btn-lg btn-danger" style="margin-top: 100px;line-height:20px;">我的后宫</a>
        </div>
        <!--弹出层end-->
        ...
        <script>
                $(document).ready(function () {
                        ...
                        $('#not-like,#like').click(function(){
                                ...
                                xhr.open('get','ajax-area?local=<?=$area?>&openid=<?=$openid?>');
                                xhr.send(null);
                        ...
                        $('.flop-content-nope,.flop-content-like').click(function(){
                                ...
                                if(active==0){
                                        ...
                                        xhr.open('get','ajax-area?type=0&openid=<?=$openid?>');

                                }else if(active==1){

                                        xhr.open('get','ajax-area?type=1&openid=<?=$openid?>');

                                }else if(active==2){

                                        xhr.open('get','ajax-area?type=2&openid=<?=$openid?>');
                ...
                function choices(id,type){
                        ...
                        if(type==1){
                                ...
                                /*喜欢*/
                                xhr.open('get','flop-like?openid=<?=$openid?>&id='+id);


                        }else if(type==0) {

                                /*不喜欢*/
                                xhr.open('get','flop-nope?openid=<?=$openid?>&id='+id);
                ...
                function addflop(id){
                        ...
                        $.get('add-flop-list?openid=<?=$openid?>&priority='+id,function (data) {

                                $('.like-count').html(data);
                                if(data==6){

                                        $('#my-modal-full').style.display='block';
