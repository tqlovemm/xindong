...
<div class="container-fluid">
    ...
    <div class="row" style="position: relative;">
        <a href="http://13loveme.com/w-flop/area?openid=<?=$openid?>" style="width:60px;height:60px;cursor: pointer;background-color: rgba(128, 128, 128, 0.4);text-align:center;line-height: 60px;border-radius: 50%;position: fixed;right:5%;top:5%;z-index: 99999;font-size: 18px;">跳过</a>
        <!-- 本例主要代码 Start ================================ -->
        <div id="focus" class="focus">
          ...
          <!--          <li><img src="<?/*=Yii::getAlias('@web')*/?>/images/flop/1.jpg" /></li>-->
                    ...
                    <li><img src="<?=Yii::getAlias('@web')?>/images/flop/8.jpg" /></li>
                    <li>
                        <div style="position: relative;">

                            <img src="<?=Yii::getAlias('@web')?>/images/flop/7.jpg" />
                            <a href="http://13loveme.com/w-flop/area?openid=<?=$openid?>" style="position: absolute;width:200px;height:60px;background-color: transparent;z-index: 9999;bottom:16%;left:50%;margin-left: -100px;"></a>
