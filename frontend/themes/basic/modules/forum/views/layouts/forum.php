...
<body>
    ...
    <div class="modal-shiftfix wrap">
        ...
        <header class="navbar navbar-fixed-top scroll-hide">
            <div class="container top-bar visible-xs">
                ...
                <a class="logo" href="<?= Url::toRoute(['/forum/forum/views']) ?>"><?= Html::encode($this->params['forum']['forum_name']) ?></a>
            </div>
            <div class="container main-nav clearfix">
                <div class="nav-collapse ">
                    <div class="pull-left">
                        <div class="page-title">
                            <h1 style="color:#FF812C;">
                                <?= Html::encode($this->params['forum']['forum_name']) ?>
                            </h1>
                        </div>
                    </div>
                    ...
                    <div class="pull-right" style="margin-top:6px">
                        <ul class="nav navbar-nav pull-right">
                            <li class="dropdown user hidden-xs"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                ...
                                <img width="34" height="34" src="<?= Yii::getAlias('@avatar') . Yii::$app->user->identity->avatar ?>" alt="User Avatar">


                                <?= Yii::$app->user->identity->username ?><b class="caret"></b></a>


                                <ul class="dropdown-menu">
                                    <li><a href="<?= Url::toRoute(['/u/'.Yii::$app->user->identity->username]) ?>">
                    ...
                    <div class="pull-right">
                        <ul class="nav">
                            <li class="current">
                        <!--        <a href="<?/*= Url::toRoute(['/forum/forum/view', 'id' => $this->params['forum']['forum_url']]) */?>">
                                    <span aria-hidden="true" class="glyphicon glyphicon-home">

                                    </span><?/*= Yii::t('app', 'Home') */?>
                                </a>-->
                                    <a href="<?=Url::toRoute(['/forum/forum/views'])?>"><span aria-hidden="true" class="glyphicon glyphicon-home"></span><?= Yii::t('app', 'Home') ?></a>
               ...
               <!--             <?php /*if ($this->params['forum']['user_id'] == Yii::$app->user->id): */?>
                    ...
                    <!--        <li><a href="<?/*= Url::toRoute(['/forum/forum/broadcast', 'id' => $this->params['forum']['forum_url']]) */?>">
                            ...
                            <?php else: ?>
                            <li class="visible-xs"><a href="<?= Url::toRoute(['/u/'.Yii::$app->user->identity->username]) ?>">
        ...
        <div class="container-fluid main-content">
            ...
            <div class="row">
                <?= Breadcrumbs::widget([
                    'homeLink' => ['label' => Yii::t('app', 'Home'), 'url' => ['/forum/forum/views']],
    ...
    <footer class="footer">
        ...
        <p class="pull-right"> <?= Html::a (' 中文简体 ', '?lang=zh-CN') . '| ' .
