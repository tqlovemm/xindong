...
<?php $this->beginPage() ?>
    ...
    <div id="wrapper">
            ...
            <ul class="nav-notification clearfix">
                <li class="dropdown visible-xs">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="clearfix" href="/index.php/forum/forum/views">
                                <i class="glyphicon glyphicon-home"></i>
                                首页
                            </a>
                        </li>
                        <li>
                            <a tabindex="-1" href="/index.php/u/<?=Yii::$app->user->identity->username?>" class="main-link">
                                <i class="glyphicon glyphicon-user"></i>
                                个人主页
                            </a>
                        </li>
                        <li>
                            <a tabindex="-1" href="/index.php/user/message" class="theme-setting">
                ...
                <li class="dropdown hidden-xs">
                    <a class="dropdown-toggle" href="/index.php/forum/forum/views?sort=-t.created_at">
                        <i class="glyphicon glyphicon-home">首页</i>
                    </a>
                </li>
                <li class="dropdown hidden-xs">
                    <a class="dropdown-toggle" href="/index.php/u/<?=Yii::$app->user->identity->username?>">
                        <i class="glyphicon glyphicon-user">个人主页</i>
                    </a>
                </li>
                <li class="dropdown hidden-xs">
                    <a class="dropdown-toggle" href="/index.php/user/message">
                ...
                <li class="profile dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="clearfix" href="#">
                                <img src="<?= Yii::getAlias('@avatar') . $user->avatar ?>" alt="十三平台头像">
                                <div class="detail">
                                    <strong><?= Html::encode($user->username) ?></strong>
                        ...
                        <li><a tabindex="-1" href="<?= Url::toRoute(['/user/view', 'id' => $user->username]) ?>" class="main-link"><i class="glyphicon glyphicon-edit"></i> 个人档</a></li>
                        <li><a tabindex="-1" href="<?= Url::toRoute(['/user/setting']) ?>" class="theme-setting"><i class="glyphicon glyphicon-cog"></i>设置</a></li>
                        <li class="divider"></li>
                        <li><a tabindex="-1" class="main-link" data-toggle="modal" data-target="#logoutConfirm">
                                <i class="glyphicon glyphicon-log-out"></i>退出</a></li>
                    </ul>
                </li>
            ...
            <div class="sidebar-inner scrollable-sidebar" style="overflow: hidden; height: 100%;">
                ...
                <div class="main-menu">
                    <ul>
                        ...
                        <li <?php if($_SERVER['PHP_SELF']=='/index.php/forum/forum/views' ){echo 'style="background: rgba(198, 81, 81,1);"';}?>>
                            <a href="<?= Url::toRoute(['/forum/forum/views?sort=-t.created_at']) ?>">
                        ...
                        <li <?php if($_SERVER['PHP_SELF']=='/index.php/home/post' ){echo 'style="background: rgba(198, 81, 81,1);"';}?>>
                        ...
                        <li <?php if($_SERVER['PHP_SELF']=='/index.php/home/album' ){echo 'style="background: rgba(198, 81, 81,1);"';}?>>
                        ...
                        <li <?php if($_SERVER['PHP_SELF']=='/index.php/user/claims' ){echo 'style="background: rgba(198, 81, 81,1);"';}?>>
        ...
        <div id="main-container">
            <div id="breadcrumb">
                <?= Breadcrumbs::widget([
                    'homeLink' => ['label' => '首页', 'url' => ['/forum/forum/views?sort=-t.created_at']],
        ...
        <footer>
            <div class="row">
                <div class="col-sm-6">
                    <p class="no-margin">
                        &copy; <?= date('Y') ?> <strong><?= Html::a(Yii::$app->setting->get('siteName'), ['/site/index']) ?></strong>
...
<!--    <div id="scroll-to-top"><span class="glyphicon glyphicon-menu-up"></span></div>-->
    ...
    Modal::begin([
        'id' => 'logoutConfirm',
        'header' => '<h2>退出</h2>',
        'footer' => Html::a('退出', ['/site/logout'], ['class' => 'btn btn-default'])
    ]);
    echo '您确定退出';
    Modal::end();
    ?>
