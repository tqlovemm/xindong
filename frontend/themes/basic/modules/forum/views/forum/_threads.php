...
$this->registerCss('
    ...
    .show_reply{background-color:#F2F2F5;}
    .show_post{background-color:#F2F2F5;}
...
<div class="threads threads_content" id="content">
    <?php foreach($threads2 as $thread): ?>
    ...
    <?php endforeach;?>
    <div class="text-center"> <?=LinkPager::widget(['pagination' => $thread2_pages,])?></div>
</div>
<script>
    $(function(){
