                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tbody>
                        <tr>
                            ...
                            <td width="50" align="right" valign="middle" title="<?= Yii::t('app', 'Note') ?>">

                                <?= Html::a('<span class="glyphicon glyphicon-thumbs-up"></span> ' . $thread['note'], ['/forum/thread/note', 'id' => $thread['id']], ['class' => 'badge']); ?>
                            </td>
                        </tr>
                    </tbody>
                </table>
