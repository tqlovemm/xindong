    ...
    public function actionFollow($id)
    {
    	...
    	if (/*Yii::$app->Request->isAjax */Yii::$app->user->id !== $id) {
            if (User::getIsFollow($id)) {
                ...
                Yii::$app->sigin->updateKey('limit_attention',Yii::$app->user->id,-1);
                Yii::$app->sigin->updateKey('sigindata',Yii::$app->user->id,-1);

                return '<i class="glyphicon glyphicon-plus text-danger"></i>关注';
                ...
                Yii::$app->sigin->updateKey('limit_attention',Yii::$app->user->id);
                Yii::$app->sigin->updateKey('sigindata',Yii::$app->user->id);
