...
<div id="main" style="padding:10px;background-color: #fbf9fe;">
    ...
    <div class="demo">
        <form id="imageform" method="post" enctype="multipart/form-data" action="/sm/default/uploader">
        ...
        <form id="imageweima" method="post" enctype="multipart/form-data" action="/sm/default/uploader-weima">
            <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    <div class="weui_cell_bd weui_cell_primary">
                        <div class="weui_uploader">
        ...
        <form method="post" action="/sm/default/text?id=<?=$queries['member_id']?>" onsubmit="return validate_form(this);">
...
<script type="text/javascript">
    ...
    function delete_img(id){
        ...
        if(confirm('确认删除')){
            $.get('/sm/default/delete?id='+id, function (data) {
                history.go(0);
            });
        }
    ...
    $('#preview_weima').on('click',function () {
        if(confirm('确定删除吗')){
            $.get('/sm/default/delete-weima?id='+$('#preview_weima .preview').attr('data-id'),function (data) {
                history.go(0);
            });
        }
    })
