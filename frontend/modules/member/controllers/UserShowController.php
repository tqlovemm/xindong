...
class UserShowController extends Controller
{
    ...
    public function actionUpdateDetails($id,$uid=null){
        ...
        return $this->render('update-details',['model'=>$model,'update_id'=>$query_app->id,'query_app'=>$query_app,'model_member'=>$model_member,'group_id'=>$group_id,'need_price'=>$need_price,'level'=>$level,'query'=>$query]);
