...
<div class="row" style="padding:20px 10px 0;background-color: #fff;color:#b5b5b5;">为了确保您的升级成功，升级之后请务必联系微信私人客服核实，给您带来不便请谅解。</div>
<div class="row" style="padding:20px 10px;background-color: #fff;">
    <ul class="list-group">
        <li class="list-group-item clearfix">
            <a href="alipay-member-upgrade?id=<?=$id?>">
        ...
        <br>
        <li class="list-group-item clearfix">
            <a href="http://13loveme.com/member/user-show/member-upgrade-wxpay?id=<?=$id?>">
...
<?php //$this->render("../common/contact");?>