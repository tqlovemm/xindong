...
<div id="main" class="row" style="padding:10px;background-color: #fbf9fe;">
    ...
    <?php if($model->status==3):?>
        <p style="color: red;">报名审核不通过，原因:<?=$model->extra;?>,可修改后重新提交，点击图片可删除重新上传。</p>
    <?php endif;?>
    ...
    <div class="demo">
                                ...
                                <div class="weui_uploader_files" id="preview">
                                    ...
                                    if(!empty($imgs)):
                                        foreach ($imgs as $item):
                                            ?>
                                            <img src="<?=$item['thumb']?>" data-id="<?=$item['id']?>" class="preview collecting-files-img">
                                            <?php
                                        endforeach;
                                    endif;
                                    ?>
        ...
        <form method="post" action="detail?openId=<?=$session->get("openId");?>" onsubmit="return validate_form(this);">
            <div class="form-group">
                <div class="weui_cells weui_cells_form">
                    <div class="weui_cell">
                        <div class="weui_cell_hd" style="font-size: 14px;"><label class="weui_label">编号<small>（选填）</small></label></div>
                        <div class="weui_cell_bd weui_cell_primary">
            ...
            <div class="weui_cells_title" style="color: #333333;font-weight: bold;">性别</div>
            <div class="weui_cells weui_cells_radio">
                <label class="weui_cell weui_check_label" for="x13">
                    <div class="weui_cell_bd weui_cell_primary">
                        <p style="color: grey;font-weight: 200;">男生</p>
                    </div>
                ...
                <label class="weui_cell weui_check_label" for="x11">
                    <div class="weui_cell_bd weui_cell_primary">
                        <p style="color: grey;font-weight: 200;">女生</p>
                    </div>
                    <div class="weui_cell_ft">
            ...
            <div class="weui_cells_title" style="color: #333333;font-weight: bold;">交友宣言</div>
            <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    <div class="weui_cell_bd weui_cell_primary">
