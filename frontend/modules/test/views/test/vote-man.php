...
$this->registerCss("
    ...
    .weicaht-note {display:block;padding: 3px 0;margin-top:3px;background:#22222E;color:#C1C1C1;text-align:center;border-radius: 3px;font-size: 20px;z-index: 9;border: none;}
...
<div class="nav-tabs-top" >
    ...
    <ul id="myTab" class="nav nav-tabs nav-tabs-man text-center" style="margin-bottom: 0px;background-color: #fff;">
        <li class="active box-shadow" style="width: 33.33%">
            <a href="man" style="margin: 0">男生 <img style="width: 25px;margin-top: -4px;" src="/images/vote/906898231657870808.png"></a>
        </li>
    ...
    <div class="tab-pane fade in active" id="man">
        <ul class="wall" >
            ...
            foreach ($model as $key=>$item):?>
                <li class="article" style="text-align: center;float: left;" >
