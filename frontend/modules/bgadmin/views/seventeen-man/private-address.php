...
<div class="container-fluid" style="padding: 0;">
    ...
    <div class="row">
        <?php foreach ($already_areas as $list):?>
            <a style="display: block;background-color: #fff;padding:10px 5px;border-bottom: 1px solid #eee;" href="seventeen-area?area=<?=$list?>">
                <div class="col-xs-8">
                    <?=$list?>
                </div>
