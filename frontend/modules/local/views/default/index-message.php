...
<div id="header" style="padding:10px;background-color: #2695D0;text-align: center;color:#fff;font-size: 20px;font-weight: bold;position: relative;">
    <?=$this->title?>
    <a style="position: absolute;top:0;right:10px;line-height: 52px;color:#fff;font-size: 12px;"></a>
</div>
        ...
        <div class="form-group">
            <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" type="text" disabled value="<?=$queries['member_id']?>"/>
                    </div>
                </div>
                <div class="weui_cell">
            ...
            <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" disabled value="<?=$queries['birthday']?> 岁"/>
                    </div>
                </div>
                <div class="weui_cell">
