...
<div id="main" style="padding:10px;background-color: #fbf9fe;">
    ...
    <div class="demo">
        <form id="imageform" method="post" enctype="multipart/form-data" action="/local/default/uploader">
            <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    <div class="weui_cell_bd weui_cell_primary">
                        <div class="weui_uploader">
                            <div class="weui_uploader_hd weui_cell">
                                <div class="weui_cell_bd weui_cell_primary">档案照上传<small> （单张上传至少4张，点击图片可删除）</small></div>
                            ...
                            <div class="weui_uploader_bd">
                                ...
                                <?php if(count($img)<6):?>
                                    <div class="weui_uploader_input_wrp btn" id="up_btn">
                                        <input type="hidden" value="<?=$queries['member_id']?>" name="id">
        ...
        <form id="imageweima" method="post" enctype="multipart/form-data" action="/local/default/uploader-weima">
            <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    <div class="weui_cell_bd weui_cell_primary">
                        <div class="weui_uploader">
                            ...
                            <div class="weui_uploader_bd">
                                <div class="weui_uploader_files" id="preview_weima">
                                    <?php if(!empty($queries['weima'])):?>
                                        <img onclick="delete_img(<?=$queries['id']?>)" src="<?=$pre_url.$queries['weima']?>"  class="preview">
                                    <?php endif;?>
                                </div>
                                <?php if(empty($queries['weima'])):?>
        ...
        <form method="post" action="/local/default/text?id=<?=$queries['member_id']?>" onsubmit="return validate_form(this);">
            <div class="form-group">
                    ...
                    <div class="weui_cell weui_cell_select weui_select_after">
                        ...
                        <div class="weui_cell_bd weui_cell_primary">
                            <select class="weui_select" name="annual_salary">
                                ...
                                <option value="10-20万" <?php if($queries['annual_salary']=="10-20万"):?>selected<?php endif;?>>10-20万</option>
                                <option value="20-50万" <?php if($queries['annual_salary']=="20-50万"):?>selected<?php endif;?>>20-50万</option>
                                <option value="50-100万" <?php if($queries['annual_salary']=="50-100万"):?>selected<?php endif;?>>50-100万</option>
                                <option value="100-300万" <?php if($queries['annual_salary']=="100-300万"):?>selected<?php endif;?>>100-300万</option>
                                <option value="300-500万" <?php if($queries['annual_salary']=="300-500万"):?>selected<?php endif;?>>300-500万</option>
                                <option value="1000万以上" <?php if($queries['annual_salary']=="1000万以上"):?>selected<?php endif;?>>1000万以上</option>
                            </select>
                        </div>
                    </div>
                    <div class="weui_cell">
                ...
                <div class="weui_cells weui_cells_form">
                    <div class="weui_cell">
                        <div class="weui_cell_bd weui_cell_primary">
                            <textarea class="weui_textarea" maxlength="15" name="like_type" placeholder="喜欢妹子类型" rows="1"><?=$queries['like_type']?></textarea>
                            <div class="weui_textarea_counter"><span>0</span>/15</div>
                        </div>
                    </div>
                </div>
