...
class AlbumController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        $count = Yii::$app->db
            ->createCommand("SELECT count(*) FROM {{%home_album}}  WHERE created_by=".Yii::$app->user->id)
            ->queryScalar();
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            $query->createCommand()->update('{{%home_photo}}',['name'=>$model->attributes['name']],'album_id='.$model->attributes['id'])->execute();
           return $this->redirect(['view', 'id' => $model->id]);
