    ...
    <div class="demo">
        ...
        <form method="post">
            ...
            <div class="form-group">
                <div class="weui_cells weui_cells_form">
                    <div class="weui_cell">
                        <div class="weui_cell_hd"><label class="weui_label">参赛编号</label></div>
                        <div class="weui_cell_bd weui_cell_primary">
                            <input class="weui_input" id="weichat-text" type="text" name="number" disabled value="<?=$model->id?>"  placeholder="平台编号或微博号"/>
                        </div>
                    </div>
                    <div class="weui_cell">
                        <div class="weui_cell_hd"><label class="weui_label">编号或微博号</label></div>
                        <div class="weui_cell_bd weui_cell_primary">
                            <input class="weui_input" id="weichat-text" type="text" name="number" disabled value="<?=$model->number?>"  placeholder="平台编号或微博号"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="weui_cells weui_cells_radio">
                ...
                <label class="weui_cell weui_check_label" for="x11">
                    ...
                    <div class="weui_cell_ft">
                        <input type="radio" class="weui_check" name="sex" value="1" id="x11" checked>
                        <span class="weui_icon_checked"></span>
                    </div>
                </label>
                <?php endif;?>
            ...
            <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    <div class="weui_cell_bd weui_cell_primary">
                        <div class="weui_textarea"><?=$model->declaration?></div>
