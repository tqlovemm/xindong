...
/**
 * This is the model class for table "pre_kunshe_weima_record".
 *
 * @property integer $id
 ...
 */
class KunsheWeimaRecord extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pre_kunshe_weima_record';
    }
    ...
    {
        return $this->hasOne(KunsheWeima::className(), [ 'sence_id'=>'scene_id' ]);
    }
}
