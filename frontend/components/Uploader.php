...
class Uploader
{
     ...
     */
    public function __construct( $fileField , $config , $prefix = '', $addWaterMark=false,$base64 = false)
    {
    ...
    private function upFile( $base64 )
    {
        ...
        if($this->addWaterMark){
            ...
            $water->imgMark($this->fullName,$this->waterMark,'http://13loveme.com/images/watermark/shi_san~ping_~tai_watermark_02.png');
        }
    }
